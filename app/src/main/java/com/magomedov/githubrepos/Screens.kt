...
object Screens {
    ...
    fun repositoryDetails(repository: Repository) = FragmentScreen { RepositoryDetailsFragment.createFragment(repository = repository) }
    fun profile(repositoryDetails: RepositoryDetails) = FragmentScreen { ProfileDetailsFragment.createFragment(repositoryDetails = repositoryDetails) }
